...
export const RestaurantMenu = () => {
  ...
  return menu != undefined && Object.keys(menu).length === 0 ? (
    ...
    <div className="text-center flex justify-center px-10 min-h-[490] pb-4 bg-white">
      <div >
        <div className=" text-black mt-7 ml-56 w-[800] flex justify-between min-h-[100] border-dotted border-b-4 pb-6">
        ...
        <div className="flex ml-[232] mt-3 mb-2 font-bold text-black text-lg font-sans">
