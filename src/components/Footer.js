      ...
      <div className="flex flex-col">
        ...
        <div className="flex ml-8 mt-1">
          <button className="mx-1">
            <a href="https://github.com/Devanshjain2110" target="_blank">
              <img
                src={Github}
                alt=""
          ...
          <button className="hover:shadow-white rounded-full  ">
            <a href="https://www.linkedin.com/in/devanshja/" target="_blank"><img src={Linkedin} alt="" className="h-11 -ml-1"/></a>
          </button>
          <button className="bg-white rounded-full mt-2 mb-2 px-1 mx-1">
            <a href="https://twitter.com/devansh_webdev" target="_blank"><img src={Twitter} alt="" className="h-7"/></a>
          </button>
        </div>
      </div>
